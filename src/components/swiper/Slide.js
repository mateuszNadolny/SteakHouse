...
const Slide = () => {
    return ( 
        <div className={`${styles["slide-content-wrapper"]} row`}>
            <div className={`${styles["slide-content-wrapper-text"]} col-6-desktop col-6-laptop col-12-mobile`}>
            ...
            <div className={`${styles["slider-content-wrapper-img"]} col-6-desktop col-6-laptop col-12-mobile`}>
